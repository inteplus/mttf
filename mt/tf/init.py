...
def init():
    ...
    if tf_ver < version.parse('2.5'):
        ...
        if tf_ver < version.parse('2.4'):
            setattr(tensorflow.python.keras.applications,
        ...
        setattr(tensorflow.keras.optimizers.schedules,
                'CosineDecay', lr_extra.CosineDecay)
    ...
    if tf_ver < version.parse('2.5'):
        import h5py as _h5
        # hack because h5py>=3.0.0 behaves differently from h5py<3.0.0
        if _h5.__version__.startswith('3.'):
    ...
    if tf_ver < version.parse('2.8'):
        ...
        if tf_ver < version.parse('2.4'):
            ...
            setattr(tensorflow.python.keras.applications,
                    'effiicientnet_v2', efficientnet_v2)
